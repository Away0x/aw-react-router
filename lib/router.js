...
var AWRouter = /** @class */ (function () {
    ...
    AWRouter.prototype.load = function (routes, options) {
        ...
        this.history = this.mode === 'hash' ? history_1.createHashHistory() : history_1.createBrowserHistory();
    ...
    // ------------------------------- history -------------------------------
    AWRouter.prototype.push = function (path, options) {
        if (options === void 0) { options = {}; }
        if (options.replace) {
    ...
    AWRouter.prototype.pushByName = function (name, options) {
        if (options === void 0) { options = {}; }
        var route = this.find(name);
        if (!route) {
